...
parser.add_argument('--method', type=bool, default='dropout', 
...
sim_model = get_forward_sim(params=params, zdot_model=zdot_model, runs=runs, stride=stride, dt=dt, tol=tol)
